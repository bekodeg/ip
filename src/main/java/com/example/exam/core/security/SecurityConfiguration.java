...
import com.example.exam.models.UserRole;
import com.example.exam.mvc.CollaboratorSignupController;
...
@Bean
    SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(requests -> requests
                ...
                .requestMatchers(CollaboratorSignupController.URL).anonymous()
